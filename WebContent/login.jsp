                  ...
                  <TBODY>
                    <TR>
                      <TD height=54 valign="top" background="<%=path %>/images/admin_3_4.gif"><table width="70%"  border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><div style="FONT-WEIGHT: bold; FONT-SIZE: 23pt; FILTER: Glow(Color=#00347F,Strength=4); WIDTH: 100%; COLOR: #ffffff; font-family: 宋体; margin-left: 70px;">商务信息学院学生信息管理系统</div></td>
                          </tr>
                      </table></TD>
                    </TR>
                  </TBODY>
                                    ...
                                    <TR>
                                      ...
                                      <TABLE style="FONT-SIZE: 12px" cellSpacing=0 cellPadding=0 width="92%" align=center border=0>
                                            ...
                                            <TR>
                                                  ...
                                                  <input name="userName" type="text" id="userName" size="15"style="margin-left: 12px;"></TD>
                                            </TR>
                                            <TR>
