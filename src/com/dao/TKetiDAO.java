...
/**
 * Data access object (DAO) for domain model class Tketi.
 * 
 * @see com.model.Tketi
...
public class TKetiDAO extends HibernateDaoSupport
{
	...
	{
		log.debug("saving Tketi instance");
		try
		{
	...
	{
		log.debug("deleting Tketi instance");
		try
		{
	...
	{
		log.debug("merging TKeti instance");
		try
		{
	...
	{
		log.debug("attaching clean TKeti instance");
		try
		{
